    ...
    <div>
      ...
      <pattern  x="-73.4" y="-378.3" width="72" height="72" patternUnits="userSpaceOnUse" id="_x36__lpi_50_x25_" viewBox="72.2 -72 72 72">
        ...
        <g id="Words">
          ...
          <g id="over_x5F_obese">
              {res === 'overObese' ?
                  <div><path className="notAlert" d="M493.3,135.4L302.2,295.7H302L455.8,98.9c7.8,6.2,15.3,12.8,22.3,19.8C483.4,124.1,488.5,129.6,493.3,135.4z"/>
          ...
          <g>
            	<path className="BMI_Graph_pointer" transform={rotationDegree} d="M302.2,230.6c35.8-0.1,64.7,29.7,63.1,65.9c-1.4,32.7-28.2,59.1-60.9,60.1c-25.7,0.8-48-13.8-58.6-35.2c-1.2-2.5-3.1-4.6-5.5-5.9l-35.5-20.4c-1.3-0.8-1.3-2.7,0-3.4l36-20.9c2.3-1.4,4.2-3.4,5.4-5.8C256.6,244.6,277.8,230.6,302.2,230.6z"/>
          </g>
          { text }</g>
      </svg>
    </div>
