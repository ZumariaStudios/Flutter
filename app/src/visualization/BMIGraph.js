  ...
  return(
    <div>
      ...
      <pattern  x="-73.4" y="-378.3" width="72" height="72" patternUnits="userSpaceOnUse" id="_x36__lpi_50_x25_" viewBox="72.2 -72 72 72">
      	<g>
      		<rect x="72.2" y="-72" className="st0" width="72" height="72"/>
      		<g className="st1">
      			<line x1="144" y1="-6" x2="216.5" y2="-6"/>
      			<line x1="144" y1="-30" x2="216.5" y2="-30"/>
      			<line x1="144" y1="-54" x2="216.5" y2="-54"/>
      			<line x1="144" y1="-18" x2="216.5" y2="-18"/>
      			<line x1="144" y1="-42" x2="216.5" y2="-42"/>
      			<line x1="144" y1="-66" x2="216.5" y2="-66"/>
      		</g>
      		<g className="st1">
      			<line x1="72" y1="-6" x2="144.5" y2="-6"/>
      			<line x1="72" y1="-30" x2="144.5" y2="-30"/>
      			<line x1="72" y1="-54" x2="144.5" y2="-54"/>
      			<line x1="72" y1="-18" x2="144.5" y2="-18"/>
      			<line x1="72" y1="-42" x2="144.5" y2="-42"/>
      			<line x1="72" y1="-66" x2="144.5" y2="-66"/>
      		</g>
      		<g className="st1">
      			<line x1="0" y1="-6" x2="72.5" y2="-6"/>
      			<line x1="0" y1="-30" x2="72.5" y2="-30"/>
      			<line x1="0" y1="-54" x2="72.5" y2="-54"/>
      			<line x1="0" y1="-18" x2="72.5" y2="-18"/>
      			<line x1="0" y1="-42" x2="72.5" y2="-42"/>
      			<line x1="0" y1="-66" x2="72.5" y2="-66"/>
      		</g>
      	</g>
        </pattern>
        <g id="Words">
          	<g>
          		<g className="st2">
          			<path className="st2" d="M15.5,269.6l11.6,1.3c4.4,0.5,6.4-1.3,6.7-3.9c0.3-2.9-1.4-5-5.7-5.4l-11.6-1.3l0.3-2.5l11.4,1.3c6,0.7,8.1,4.1,7.6,8.3c-0.4,4-3.1,6.8-9.1,6.1l-11.5-1.3L15.5,269.6z"/>
          ...
          <g id="Big_Slices">
              	<g><path className="st2" d="M124.6,121.6c-22.3,22.5-39.8,48.6-52.2,77.7c-12.8,30.1-19.5,62-19.8,95h244.6L124.6,121.6z"/></g>
              	<g><path className="st2" d="M398.7,67.4c-30-12.7-61.8-19.3-94.6-19.7v243.7l172.1-172.1C453.8,97.1,427.7,79.7,398.7,67.4z"/></g>
              	<g><path className="st2" d="M127.8,119.1l172.3,172.3V47.9c-31.6,0.2-62.3,6.3-91.5,18.1C178.4,78.3,151.2,96.1,127.8,119.1z"/></g>
              	<g><path className="st2" d="M530.9,199.6c-12.3-28.9-29.7-55-51.9-77.5L306.9,294.2h243.6C550.3,261.4,543.7,229.6,530.9,199.6z"/></g>
              	<g><path className="st3" d="M535.9,392.7H67.3c-8.1,0-14.7-6.6-14.7-14.7v-76.3h498v76.3C550.6,386.2,544,392.7,535.9,392.7z"/></g>
          </g>
          <g id="over_x5F_obese">
              	<g><path className="st2" d="M493.3,135.4L302.2,295.7H302L455.8,98.9c7.8,6.2,15.3,12.8,22.3,19.8C483.4,124.1,488.5,129.6,493.3,135.4z"/></g>
              	<g>
              		<pattern  id="SVGID_1_" patternTransform="matrix(1 0 0 1 0 381)"></pattern>
              		<path className="st4" d="M456,101c7.3,5.8,14.4,12.1,21,18.8c4.9,4.9,9.7,10.1,14.2,15.4L311.6,285.9L456,101z"/>
              		<path className="st5" d="M456.3,103.2c6.8,5.5,13.5,11.5,19.7,17.7c4.5,4.5,8.9,9.3,13.1,14.2L321.5,275.6L456.3,103.2 M455.8,98.9L302,295.7h0.2l191.1-160.3c-4.8-5.8-9.9-11.3-15.2-16.6C471,111.7,463.6,105.1,455.8,98.9L455.8,98.9z"/>
              	</g>
              	<line x1="479.1" y1="119.2" x2="479.1" y2="119.2"/>
              	<line x1="479.1" y1="111.2" x2="479.1" y2="111.2"/>
          </g>
          <g id="healthy_x5F_over">
              	<g>
              		<path className="st2" d="M328.2,47.5l-26.1,248.1l-0.2,0.1L275.9,47.3c9.9-1,19.9-1.4,29.8-1.2C313.2,46.2,320.8,46.7,328.2,47.5z"/>
              	</g>
              	<g>
              		<pattern  id="SVGID_2_" patternTransform="matrix(1 0 0 1 0 381)"></pattern>
              		<path className="st6" d="M277.5,48.7c7.9-0.8,15.8-1.1,23.8-1.1c1.5,0,2.9,0,4.4,0c6.9,0.1,13.9,0.5,20.9,1.2L302.1,282L277.5,48.7z"/>
              		<path className="st5" d="M301.3,49.1c1.4,0,2.9,0,4.4,0c6.4,0.1,12.8,0.5,19.3,1.1l-22.9,217.5L279.2,50C286.5,49.4,293.9,49.1,301.3,49.1L301.3,49.1 M301.3,46.1c-8.5,0-17,0.4-25.4,1.3L302,295.7l0.2-0.1l26.1-248.1c-7.5-0.8-15-1.3-22.5-1.4C304.3,46.1,302.8,46.1,301.3,46.1L301.3,46.1z"/>
              	</g>
              	<line x1="302.1" y1="37.7" x2="302.1" y2="37.2"/>
          </g>
          <g id="under_x5F_healthy">
          	<g><path className="st2" d="M147.5,99.1l153.6,196.6l0,0.2L109.7,135.3c6.4-7.6,13.3-14.8,20.6-21.6C135.8,108.6,141.6,103.7,147.5,99.1z"/></g>
          	<g>
          		<pattern patternTransform="matrix(1 0 0 1 660 381)"></pattern>
          		<path className="st7" d="M111.9,135.2c6.1-7.1,12.6-13.9,19.5-20.3c5.1-4.7,10.4-9.3,15.9-13.6L291.6,286L111.9,135.2z"/>
          		<path className="st5" d="M147,103.3l134.6,172.3L114,135c5.8-6.7,11.9-13.1,18.4-19.1C137,111.6,142,107.3,147,103.3 M147.5,99.1c-5.9,4.6-11.7,9.5-17.2,14.6c-7.3,6.8-14.2,14-20.6,21.6l191.3,160.5l0-0.2L147.5,99.1L147.5,99.1z"/>
          	</g>
          </g>
          <g id="Dial" className="st8">
            	<polygon points="302.9,268.5 302.3,269.1 301.6,268.5 	"/>
            	<polygon points="302.3,268.5 302.3,269.1 301.6,268.5 	"/>
            	<polygon points="302.9,268.5 302.3,269.1 302.3,268.5 	"/>
            	<g><path d="M302.2,230.6c35.8-0.1,64.7,29.7,63.1,65.9c-1.4,32.7-28.2,59.1-60.9,60.1c-25.7,0.8-48-13.8-58.6-35.2c-1.2-2.5-3.1-4.6-5.5-5.9l-35.5-20.4c-1.3-0.8-1.3-2.7,0-3.4l36-20.9c2.3-1.4,4.2-3.4,5.4-5.8C256.6,244.6,277.8,230.6,302.2,230.6z"/></g>
            	<g className="">
              		<line x1="386.4" y1="324.9" x2="385.3" y2="325.9"/>
              		<line x1="194.2" y1="486.2" x2="193.6" y2="486.7"/>
              		<line cx1="348.6" y1="288.4" x2="347.8" y2="289.4"/>
              		<line x1="194" y1="486.2" x2="193.6" y2="486.7"/>
            	</g>
          </g>
      </svg>
    </div>
